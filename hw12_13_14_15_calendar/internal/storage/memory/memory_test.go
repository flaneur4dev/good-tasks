		...
		events := [...]cs.Event{
			{
				...
				NotificationDay: time.Date(2023, time.September, 01, 0, 0, 0, 0, time.UTC),
			},
			{
				ID:              "2",
				Title:           "event 2",
				...
				NotificationDay: time.Date(2023, time.September, 05, 0, 0, 0, 0, time.UTC),
			},
			{
				ID:              "3",
				Title:           "event 3",
				...
				NotificationDay: time.Date(2023, time.August, 28, 0, 0, 0, 0, time.UTC),
			},
			{
				ID:              "4",
				Title:           "event 4",
				...
				NotificationDay: time.Date(2023, time.October, 12, 0, 0, 0, 0, time.UTC),
			},
			{
				ID:              "5",
				Title:           "event 5",
				...
				NotificationDay: time.Date(2023, time.September, 23, 0, 0, 0, 0, time.UTC),
			},
		}
		...
		tests := [...]struct {
			...
			},
			{
				input: cs.Event{
					...
					NotificationDay: time.Date(2020, time.December, 01, 0, 0, 0, 0, time.UTC),
				},
